...
// Add your custom receipt route below the existing receipt route
Route::get('/orders/my-receipt/{order}', [ OrdersController::class, 'myCustomOrderReceipt'])->name(ns()->routeName('ns.dashboard.orders-my-receipt'));
