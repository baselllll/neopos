                ...
                <div class="flex-auto overflow-y-auto" v-if="hasLoadedRegisters">
                    <div class="grid grid-cols-3">
                        <div @click="selectRegister( register )" v-for="(register, index) of registers" 
                            ...
                            :key="index" class="border flex items-center justify-center flex-col p-3" style="background-color: #fff;">
                            <i class="las la-cash-register text-6xl" style="color:#111"></i>
