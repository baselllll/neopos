<template>
    <div class="shadow-lg modal-background ready-meal-modal ns-box w-6/7-screen md:w-3/5-screen lg:w-2/5-screen h-6/7-screen flex flex-col overflow-hidden">
        <div class="p-2 flex justify-center items-center ns-box-header ">
            <h3 class="font-semibold">{{ __( 'Orders' ) }}</h3>
            <div>
                <ns-close-button @click="$popup.close()"></ns-close-button>
            </div>
        </div>
        <div class=" flex overflow-hidden flex-auto ns-box-body ">
        ...
        <div class="p-2 flex  ns-box-footer justify-center">
            <div></div>
            <div>
