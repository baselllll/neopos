            ...
            <ns-tabs :active="activeTab" @changeTab="changeActive( $event )">
                ...
                <ns-tabs-item padding="0" :label="__( 'Summary' )" identifier="summary" :active="false">
                    <div class="p-2" v-if="order">
                        <div style="color: rgb(0 0 0);" v-for="tax of order.taxes" :key="tax.id" class="mb-2 border shadow p-2 w-full flex justify-between items-center elevation-surface">
                ...
                <ns-tabs-item padding="0" :label="__( 'Product Taxes' )" identifier="product_taxes" :active="false">
                    <div class="p-2" v-if="order">
                        <div style="color: rgb(0 0 0);" class="border shadow p-2 w-full flex justify-between items-center elevation-surface">
