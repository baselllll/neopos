        ...
        <template v-if="Object.values( form ).length > 0">
            <div class="flex flex-col">
                ...
                <div :class="form.main.disabled ? '' : form.main.errors.length > 0 ? 'border-error-tertiary' : ''" class="input-group info flex border-2 rounded overflow-hidden">
                    ...
                    <button :disabled="form.main.disabled" :class="form.main.disabled ? '' : form.main.errors.length > 0 ? 'bg-error-tertiary' : ''" @click="submit()" class="outline-none px-4 h-10 rounded-none" style="background-color: rgb(15, 23, 42);"><slot name="save">{{ __( 'Save' ) }}</slot></button>
                </div>
                        ...
                        <div id="card-header" class="flex flex-wrap justify-between ns-tab">
                            <div class="flex flex-wrap">
                                <template v-for="( tab, index ) in variation.tabs">
                                    <div @click="setTabActive( index, variation.tabs )" :class="tab.active ? 'active' : 'inactive'" v-if="tab.visible" v-bind:key="index" class="tab cursor-pointer text-primary px-4 py-2 rounded-tl-lg rounded-tr-lg flex justify-between" style="background-color: rgb(15, 23, 42);">
