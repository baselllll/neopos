...
<template>
    <div class="ns-button default">
        <button @click="openOrderTypeSelection()" class="rounded shadow tab-buttons flex-shrink-0 h-12 flex items-center px-2 py-1 text-sm">
            <img src="/images/order-type.png" class="mr-2" alt="">
