    ...
    <div class="-mx-4 flex flex-wrap">
            ...
            <div class="w-full mb-2 flex-wrap flex">
                ...
                <div class="mb-2 w-full md:w-1/2 px-4">
                    <div class="elevation-surface border p-2 flex justify-between items-start">
                        <div>
                            <h4 class="text-semibold text-secondary">{{ __( 'Sub Total' ) }}</h4>
                        </div>
                ...
                <div class="mb-2 w-full md:w-1/2 px-4">
                    <div class="p-2 flex justify-between items-start elevation-surface border">
                        <div>
                            <h4 class="text-semibold text-secondary">{{ __( 'Shipping' ) }}</h4>
                        </div>
                ...
                <div class="mb-2 w-full md:w-1/2 px-4">
                    <div class="p-2 flex justify-between items-start ns-notice info">
                        <div>
                            <h4 class="text-semibold text-secondary">{{ __( 'Total' ) }}</h4>
                        </div>
                        <div class="font-semibold text-secondary">{{ order.total | currency }}</div>
                    </div>
                </div>
                <div class="mb-2 w-full md:w-1/2 px-4">
                ...
                <div class="mb-2 w-full md:w-1/2 px-4">
                    <div class="p-2 flex justify-between items-start text-secondary elevation-surface error border">
                        <div>
                ...
                <div class="mb-2 w-full md:w-1/2 px-4">
                    <div class="p-2 flex justify-between items-start elevation-surface border">
                        <div>
                            <h4 class="text-semibold text-secondary">{{ __( 'Paid' ) }}</h4>
                        </div>
                        <div class="font-semibold text-secondary">{{ order.tendered | currency }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="px-4 w-full md:w-1/2 lg:w-2/4 mb-2">
            ...
            <div class="mb-2 p-2 flex justify-between items-start elevation-surface border">
                <div>
                    <h4 class="text-semibold text-secondary">
        ...
        <div class="px-4 w-full md:w-1/2 lg:w-2/4 mb-2">
            ...
            <div :key="product.id" v-for="product of order.products" class="p-2 flex justify-between items-start elevation-surface border mb-6">
                <div>
                    <h4 class="text-semibold text-secondary">{{ product.name }} (x{{ product.quantity }})</h4>
            ...
            <div :key="index" v-for="(product, index) of order.refunded_products" class="p-2 flex justify-between items-start elevation-surface border  mb-6">
                <div>
                    <h4 class="text-semibold text-secondary">{{ product.order_product.name }} (x{{ product.quantity }})</h4>
