...
class RestaurantController extends DashboardController
{
    ...
    public function showKitchenScreen()
    {
        return $this->view('NsGastro::kitchens.body', [
            ...
            'gastroKitchenJsSrc'    => is_file( base_path( 'modules/NsGastro/.dev' ) ) ? 
                NsGastroEvent::loadFilesFromMix( '/js/GastroKitchen.js' ) : 
                NsGastroEvent::loadFilesFromMix( '/js/GastroKitchen.min.js' ),
            'gastroCssSrc'          =>  NsGastroEvent::loadFilesFromMix( '/css/gastro.css' ),
        ]);
    }
