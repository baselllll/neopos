<template>
    <div class="shadow-full ns-box w-95vw h-95vh md:w-4/5-screen lg:w-4/6-screen md:h-4/5-screen overflow-hidden flex flex-col">
        <div class="border-b ns-box-header p-2 flex flex-col md:flex-row justify-between items-center" :class="selectedTable !== null ? ( selectedTable.busy ? 'bg-success-tertiary text-white' : '' ) : ''" >
            <div class="flex-auto">
