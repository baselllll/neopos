...
class GastroTestMoveOrder extends TestCase
{
    ...
    protected $shouldMakePayment = false;

    protected $shouldRefund = false;

    protected $customDate = false;
    ...
    public function testCookingOrder()
    {
         ...
         * over a table.
         */
        $response = $this->attemptPostOrder(function ($response, $data) use ($table) {
        ...
        $order = $response[0][0]['order-creation']['data']['order'];
